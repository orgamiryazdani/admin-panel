    ...
    return (
        <>
            ...
            <Modal isOpen={showDeleteModal} open={setShowDeleteModal} title='حذف' body="آیا از حذف این دسته اطمینان دارید؟">
                <button onClick={()=>setShowDeleteModal(false)} type="button" className="btn btn-secondary fw-bolder">انصراف</button>
                <button type="button" className="btn btn-primary fw-bolder">حذف</button>
            </Modal>
        </>
    );
}
